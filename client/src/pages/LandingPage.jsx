...
const LandingPage = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#070a13', color: '#f3f4f6', fontFamily: "'Outfit', sans-serif", overflowX: 'hidden' }}>
      ...
      <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 900, height: 900, background: 'radial-gradient(circle, rgba(99,102,241,0.04) 0%, transparent 70%)', pointerEvents: 'none', zIndex: 0 }} />
      ...
      {/* ── Hero Section ── */}
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '120px 48px 80px', maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center', width: '100%' }}>
          ...
          <div style={{ animation: 'slideUp 0.9s ease-out both' }}>
            ...
            <h1 style={{ fontSize: 58, fontWeight: 900, lineHeight: 1.1, letterSpacing: '-2px', marginBottom: 24 }}>
              Manage Your <br />
            ...
            <p style={{ fontSize: 18, color: '#9ca3af', lineHeight: 1.75, maxWidth: 500, marginBottom: 40 }}>
              ...
              <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, animation: 'slideUp 0.6s ease-out 0.8s both' }}>
                  ...
                  {[
                    ...
                    { dot: '#06b6d4', text: 'Monthly attendance report generated', time: '15m ago' },
                  ].map((item, i) => (
                ...
                {/* Attendance bar */}
                <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, animation: 'slideUp 0.6s ease-out 0.9s both' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}>
                    <span style={{ fontSize: 12, fontWeight: 700, color: '#4b5563', textTransform: 'uppercase', letterSpacing: 1 }}>Weekly Attendance</span>
                    <span style={{ fontSize: 12, color: '#6366f1', fontWeight: 700 }}>94.2% avg</span>
                  </div>
                  <div style={{ display: 'flex', gap: 6, alignItems: 'flex-end', height: 48 }}>
                    {[80, 95, 88, 100, 92, 98, 85].map((h, i) => (
                      <div key={i} style={{ flex: 1, borderRadius: 4, background: `linear-gradient(180deg, #6366f1, #06b6d4)`, height: `${h}%`, opacity: 0.7, animation: `slideUp 0.5s ease-out ${1.0 + i * 0.05}s both` }} />
                    ))}
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6 }}>
                    {['M', 'T', 'W', 'T', 'F', 'S', 'S'].map((d, i) => (
                      <span key={i} style={{ flex: 1, textAlign: 'center', fontSize: 10, color: '#4b5563' }}>{d}</span>
                    ))}
                  </div>
                </div>
              </div>
      ...
      {/* ── Stats Banner ── */}
      <section id="stats" style={{ padding: '60px 48px', background: 'rgba(99,102,241,0.04)', borderTop: '1px solid rgba(255,255,255,0.04)', borderBottom: '1px solid rgba(255,255,255,0.04)', position: 'relative', zIndex: 1 }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 40, textAlign: 'center' }}>
          {[
            ...
            <div key={i} style={{ padding: '20px 0' }}>
              <div style={{ fontSize: 44, fontWeight: 900, color: s.color, letterSpacing: '-2px' }}>
      ...
      {/* ── Features Section ── */}
      <section id="features" style={{ padding: '100px 48px', maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <h2 style={{ fontSize: 44, fontWeight: 900, letterSpacing: '-1.5px', marginBottom: 16 }}>
      ...
      {/* ── Roles Section ── */}
      <section style={{ padding: '80px 48px', background: 'rgba(255,255,255,0.015)', borderTop: '1px solid rgba(255,255,255,0.04)', position: 'relative', zIndex: 1 }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            <h2 style={{ fontSize: 40, fontWeight: 900, letterSpacing: '-1.5px', marginBottom: 14 }}>Built for Every Role</h2>
      ...
      {/* ── How It Works ── */}
      <section id="howitworks" style={{ padding: '100px 48px', maxWidth: 1000, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <h2 style={{ fontSize: 44, fontWeight: 900, letterSpacing: '-1.5px', marginBottom: 14 }}>How It Works</h2>
      ...
      <section style={{ padding: '100px 48px', position: 'relative', zIndex: 1, textAlign: 'center' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 48, fontWeight: 900, letterSpacing: '-2px', marginBottom: 20 }}>
      ...
      {/* ── Footer ── */}
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '32px 48px', position: 'relative', zIndex: 1 }}>
